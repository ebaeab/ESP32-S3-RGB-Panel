...
void nv3052c_reg_init(void)
{
    ...
    spi_write_reg(0xB1,0x0B);
    spi_write_reg(0xD1,0x0B);
    spi_write_reg(0xB4,0x31);
    spi_write_reg(0xD4,0x2F);
    spi_write_reg(0xB2,0x09);
    spi_write_reg(0xD2,0x09);
    spi_write_reg(0xB3,0x2F);
    spi_write_reg(0xD3,0x2D);
    spi_write_reg(0xB6,0x14);
    spi_write_reg(0xD6,0x13);
    spi_write_reg(0xB7,0x37);
    spi_write_reg(0xD7,0x36);
    spi_write_reg(0xC1,0x08);
    spi_write_reg(0xE1,0x07);
    spi_write_reg(0xB8,0x0C);
    spi_write_reg(0xD8,0x0C);
    spi_write_reg(0xB9,0x03);
    spi_write_reg(0xD9,0x02);
    spi_write_reg(0xBD,0x13);
    spi_write_reg(0xDD,0x13);
    spi_write_reg(0xBC,0x11);
    spi_write_reg(0xDC,0x11);
    spi_write_reg(0xBB,0x10);
    spi_write_reg(0xDB,0x0F);
    spi_write_reg(0xBA,0x10);
    spi_write_reg(0xDA,0x10);
    spi_write_reg(0xBE,0x18);
    spi_write_reg(0xDE,0x1A);
    spi_write_reg(0xBF,0x0F);
    spi_write_reg(0xDF,0x11);
    spi_write_reg(0xC0,0x16);
    spi_write_reg(0xE0,0x18);
    ...
    //VST
    spi_write_reg(0x04,0x51);
    spi_write_reg(0x05,0x50);
    spi_write_reg(0x06,0x50);
    ...
    spi_write_reg(0x24,0x51);
    spi_write_reg(0x25,0x50);
    spi_write_reg(0x26,0x50);
    ...
    spi_write_reg(0x34,0x51);
    spi_write_reg(0x35,0x50);
    spi_write_reg(0x36,0x50);
    ...
    nv3052c_write_only_cmd(0x11);
    vTaskDelay(pdMS_TO_TICKS(200));
    nv3052c_write_only_cmd(0x29);
    vTaskDelay(pdMS_TO_TICKS(200));
}
